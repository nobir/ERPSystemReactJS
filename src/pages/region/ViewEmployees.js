...
function ViewEmployees() {
    ...
    const featchUsers = (pageNumber = 1) => {
        setIsLoading(true);
        Axios.get(`${ROUTES.viewEmployees}/?page=${pageNumber}`)
            .then((response) => {
                // debugger;
    ...
    const handleFormSubmit = (e, pageNumber) => {
        ...
        // debugger;
        Axios.post(`${ROUTES.viewEmployees}/?page=${pageNumber}`, search)
            .then((response) => {
                            ...
                            ? users.map((user, index) => (
                                  <tr key={index}>
                                      ...
                                      <td>
                                          ...
                                          <Link
                                              to={ROUTES.deleteEmployee.replace(
                                                  ":id",
                                                  user.id
                                              )}
                                              id="delete-btn"
