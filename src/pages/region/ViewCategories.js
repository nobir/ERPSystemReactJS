...
function ViewCategories() {
    ...
    const featchUsers = (pageNumber = 1) => {
        setIsLoading(true);
        Axios.get(`${ROUTES.viewCategories}/?page=${pageNumber}`)
            .then((response) => {
                // debugger;
                setPagination(response.data.categories);
    ...
    const handleFormSubmit = (e, pageNumber) => {
        ...
        // debugger;
        Axios.post(`${ROUTES.viewCategories}/?page=${pageNumber}`, search)
            .then((response) => {
                            ...
                            ? categories.map((category, index) => (
                                  <tr key={index}>
                                      ...
                                      <td>
                                          ...
                                          <Link
                                              to={ROUTES.deleteCategory.replace(
                                                  ":id",
                                                  category.id
                                              )}
                                              id="delete-btn"
